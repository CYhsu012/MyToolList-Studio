...
![Version](https://img.shields.io/badge/version-v0.8.9--beta-purple.svg)
...
> **當前版本號**：`v0.8.9-beta`（公開開發測試版）  
> **版本狀態**：修復 YouTube 客製音軌於中斷引導、暫停或切換遮罩時無法自動停止發聲的問題，並新增專屬「⏹️ 停止音軌」按鈕與自動連動控制。
